...
def get_installed_distributions(local_only=True,
    ...
    If ``include_editables`` is False, don't result editables.

    If ``editables_only`` is True , only result editables.

    If ``user_only`` is True , only result installations in the user
    site directory.
