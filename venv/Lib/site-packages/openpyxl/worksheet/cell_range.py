...
class CellRange(Serialisable):
    ...
    def isdisjoint(self, other):
        """
        Return ``True`` if this range has no cell in common1 with *other*.
        Ranges are disjoint if and only if their intersection is the empty range.

        :type other: openpyxl.worksheet.cell_range.CellRange
        :param other: Other sheet range.
        :return: ``True`` if the range has no cells in common1 with other.
        """
        self._check_title(other)
    ...
    def intersection(self, other):
        """
        Return a new range with cells common1 to this range and *other*
