...
# def get_DictionaryKey(uri,headers,dictionaries_name):
#     get_DictionaryKey_response=requests.get(url=uri+get_parentDictionaryKey_url,
#                                                   headers=headers).json()
#     for i in get_DictionaryKey_response['data']:
#         if i['nodeData']['name']  == dictionaries_name:
#             return i['nodeData']['_key']
