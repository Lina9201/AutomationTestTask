...
ip=the_ip
port=the_port
excel_dir="test_resourcepool.xlsx"
...
def test_edit_resource_pool(token,region,name,new_name,newtype,new_desc,newip,newport,newproxyip,newproxyport,username):
